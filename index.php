...
<head>
    ...
    <title>Opposition | Helping artists grow across digital music platforms and YouTube.</title>
    <meta name="description"
        content="Opposition helps music artists succeed on their own terms. Grow your fanbase, master digital streaming and monetize your content.">

    <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>assets/img/icon.gif" />

    <link rel="stylesheet" href="https://use.typekit.net/qtr5noi.css">
...
<body>
    ...
    <header class="main-header">
        <nav>
            <a href="/#home" class="logo"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/img/header-logo.svg" /></a>
            <ul class="nav-links">
                <li class="about"><a href="/#about" class="page-link">About</a></li>
                <li class="services"><a href="/#services" class="page-link">Services</a></li>
                <li class="partners"><a href="/#partners" class="page-link">Talent</a></li>
        ...
        <div class="wrapper">
            <section id="home">
                ...
                <ul class="social-media">
                    <li><a href="https://twitter.com/weareopposition" target="_blank"><span
                    ...
                    <ul class="artists">
                        ...
                        <li>
                            <a href="https://www.youtube.com/watch?v=CIjXUg1s5gc" target="_blank">
                                <figure>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/t.jpg"
                                        alt="T-Pain" />
    ...
    <footer class="main-footer">
        <a href="//support.google.com/youtube/answer/2952738?hl=en&rd=1" target="_blank"
            class="icon icon-YouTube-certified"></a>
        <ul class="footer-links">
            <li><a href="//bbtv.com/terms-of-service/">Terms of Service</a></li>
            <li><a href="//bbtv.com/privacy-policy/">Privacy Policy</a></li>
            <li><a href="mailto:speak@opposition.tv">Contact Us</a></li>
            <li>Copyright 2019 BroadbandTV Corp. All Rights Reserved</li>
        </ul>
        ...
        <div class="bbtv-logos">
            <a href="https://www.bbtv.com" target="_blank" class="bbtv-link"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/img/logo-bbtv.svg" /></a>
            <img class="opposition-logo"
                src="<?php echo get_template_directory_uri(); ?>/assets/img/Opposition_Hero_Logo_v3.png">
        </div>
